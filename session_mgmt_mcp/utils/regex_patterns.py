...
SAFE_PATTERNS: dict[str, ValidatedPattern] = {
    ...
    "word_extraction": ValidatedPattern(
        ...
        replacement=r"",
        description="Extract words of 3+ characters for keyword analysis",
        test_cases=[
    ...
    "word_boundary": ValidatedPattern(
        ...
        pattern=r"\b\w+\b",
        replacement=r"",
        description="Extract all word boundaries for content similarity",
        test_cases=[
            ("hello world", ["hello", "world"]),
            ("test-123", ["test", "123"]),
    ...
    "python_files": ValidatedPattern(
        ...
        pattern=r"(\w+\.py)",
        replacement=r"\1",
        description="Match Python file references",
        test_cases=[
            ("main.py script", ("main.py",)),
            ("test_file.py and other.py", ("test_file.py",)),
            ("no files here", []),
        ],
    ),
    "javascript_files": ValidatedPattern(
        ...
        test_cases=[
            ("app.js file", ("app.js",)),
            ("script.js and main.js", ("script.js",)),
            ("no files", []),
        ],
    ),
    "typescript_files": ValidatedPattern(
        ...
        test_cases=[
            ...
            ("component.ts interface", ("component.ts",)),
            ("other files", []),
        ],
    ),

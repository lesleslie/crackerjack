...
ASSIGNMENTS: dict[str, tuple[str, str, str]] = {
    ...
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/IMPLEMENTATION_STATUS.md": ("active", "canonical", "lifecycle"),
    ...
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/SKILL_SYSTEM.md": ("active", "canonical", "lifecycle"),
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/STRUCTURED_LOGGING.md": ("active", "canonical", "observability"),
    ...
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/PERFORMANCE_OPTIMIZATION_PLAN.md": (
        "complete",
        "historical",
        "observability",
    ),
    ...
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/AI_FIX_TEST_FAILURE_IMPLEMENTATION_PLAN.md": (
        "complete",
        "historical",
        "lifecycle",
    ),
    ...
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/AGENT_COORDINATION_ARCHITECTURE_ANALYSIS.md": (
        "complete",
        "historical",
        "lifecycle",
    ),
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/AGENT_COORDINATION_FIX_PLAN.md": ("complete", "historical", "lifecycle"),
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/AGENT_TEST_COVERAGE_PLAN.md": ("complete", "historical", "lifecycle"),
    ...
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/AUDIT_RESULTS.md": ("complete", "historical", "lifecycle"),
    ...
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/BATCHPROCESSOR_TROUBLESHOOTING.md": ("active", "canonical", "lifecycle"),
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/BATCHPROCESSOR_USER_GUIDE.md": ("active", "canonical", "lifecycle"),
    "docs/CHECKPOINT_2026-02-05_FINAL.md": ("complete", "historical", "persistence"),
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/CHECKPOINT_ANALYSIS_2026-02-05.md": ("complete", "historical", "persistence"),
    ...
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/COMPREHENSIVE_REMEDIATION_PLAN.md": ("complete", "historical", "lifecycle"),
    ...
    "docs/archive/2026-08-06-ai-fix-removal-cleanup/REMEDIATION_PLAN_2026-02-05.md": ("complete", "historical", "lifecycle"),

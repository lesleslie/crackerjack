...
- Work toward 100% milestone; consult `coverage.json` or `htmlcov/index.html` after changes. The ratchet enforces "never decrease" against the stored baseline. See [COVERAGE_POLICY.md](../reference/COVERAGE_POLICY.md).

...
- Work toward 42% milestone (current: 21.6%, baseline: 19.6%); consult `coverage.json` or `htmlcov/` after changes. See [COVERAGE_POLICY.md](../reference/COVERAGE_POLICY.md).

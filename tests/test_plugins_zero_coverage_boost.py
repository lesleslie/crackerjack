...
class TestPluginsBaseModule:
    ...
    def test_plugins_base_imports_successfully(self):
    ...
    def test_base_plugin_basic_functionality(self):
...
class TestPluginsHooksModule:
    ...
    def test_plugins_hooks_imports_successfully(self):
    ...
    def test_hook_plugin_basic_creation(self):
    ...
    def test_hook_plugin_configuration(self):
...
class TestPluginsLoaderModule:
    ...
    def test_plugins_loader_imports_successfully(self):
    ...
    def test_plugin_loader_basic_creation(self):
    ...
    def test_plugin_loader_discover_plugins(self):
...
class TestPluginsManagersModule:
    ...
    def test_plugin_manager_get_plugins_by_type(self):

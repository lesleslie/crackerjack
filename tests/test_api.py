...
from crackerjack.api import run_quality_checks, clean_code, run_tests, publish_package, CrackerjackAPI
...
def test_interactive_cli_basic():
    ...
    try:
        ...
        import inspect
        api = CrackerjackAPI()
        assert hasattr(api, "interactive_cli"), "API should have interactive_cli property"
        pytest.skip("Function requires specific arguments - manual implementation needed")
    except Exception as e:
...
def test_run_interactive_workflow_basic():
    ...
    try:
        ...
        import inspect
        api = CrackerjackAPI()
        assert hasattr(api, "run_interactive_workflow"), "API should have run_interactive_workflow method"
...
def test_create_workflow_options_basic():
    ...
    try:
        ...
        import inspect
        api = CrackerjackAPI()
        assert hasattr(api, "create_workflow_options"), "API should have create_workflow_options method"
...
def test_get_project_info_basic():
    ...
    try:
        ...
        import inspect
        api = CrackerjackAPI()
        assert hasattr(api, "get_project_info"), "API should have get_project_info method"

...
def test_get_service_watchdog_basic() -> None:
...
def test_is_healthy_basic() -> None:
...
def test_add_service_basic() -> None:
...
def test_remove_service_basic() -> None:
...
def test_start_watchdog_basic() -> None:
...
def test_stop_watchdog_basic() -> None:
...
def test_start_service_basic() -> None:
...
def test_stop_service_basic() -> None:
...
def test_get_service_status_basic() -> None:
...
def test_get_all_services_status_basic() -> None:
...
def test_print_status_report_basic() -> None:
...
def test_signal_handler_basic() -> None:

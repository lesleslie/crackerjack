...
class TestWorkflowOptionsBackwardCompatibility:
    ...
    def test_clean_backward_compatibility_property(self):
    ...
    def test_test_backward_compatibility_property(self):
    ...
    def test_skip_hooks_backward_compatibility_property(self):
    ...
    def test_interactive_backward_compatibility_property(self):
    ...
    def test_verbose_backward_compatibility_property(self):
    ...
    def test_commit_backward_compatibility_property(self):
    ...
    def test_publish_backward_compatibility_property(self):
    ...
    def test_bump_backward_compatibility_property(self):
    ...
    def test_no_config_updates_backward_compatibility_property(self):
    ...
    def test_all_backward_compatibility_properties_together(self):
        ...
        options = WorkflowOptions(
            ...
            execution=ExecutionConfig(interactive=False, verbose=False, no_config_updates=False),

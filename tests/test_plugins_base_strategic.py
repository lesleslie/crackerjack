...
class TestPluginMetadata:
    ...
    def test_metadata_all_fields_custom(self) -> None:
        ...
        config_schema = {"required": ["api_key"], "properties": {"api_key": {"type": "string"}}}
    ...
    def test_metadata_to_dict(self) -> None:
        ...
        assert isinstance(result["plugin_type"], str)  # Ensure enum is converted to string
...
class TestPluginBase:
    ...
    def test_plugin_base_abstract_instantiation(self, sample_metadata) -> None:
        ...
        with pytest.raises(TypeError, match="Can't instantiate abstract class PluginBase"):
            PluginBase(sample_metadata)  # type: ignore

    def test_plugin_base_concrete_instantiation(self, concrete_plugin_class, sample_metadata) -> None:
    ...
    def test_plugin_enable_disable(self, concrete_plugin_class, sample_metadata) -> None:
    ...
    def test_plugin_configure_basic(self, concrete_plugin_class, sample_metadata) -> None:
    ...
    def test_plugin_configure_with_schema_validation(self, concrete_plugin_class) -> None:
    ...
    def test_plugin_configure_no_schema(self, concrete_plugin_class, sample_metadata) -> None:
    ...
    def test_plugin_get_config_with_default(self, concrete_plugin_class, sample_metadata) -> None:
    ...
    def test_plugin_config_copy_isolation(self, concrete_plugin_class, sample_metadata) -> None:
        ...
        assert plugin._config["mutable_list"] == [1, 2, 3, 4]  # This is expected with shallow copy

    def test_plugin_abstract_methods_implementation(self, concrete_plugin_class, sample_metadata) -> None:
...
class TestPluginRegistry:
    ...
    def test_register_multiple_plugins_same_type(self, registry, multiple_plugins) -> None:
    ...
    def test_get_enabled_with_disabled_plugins(self, registry, multiple_plugins) -> None:
    ...
    def test_get_enabled_by_type(self, registry, multiple_plugins) -> None:
        ...
        # Disable hook plugin
        hook_plugin = next(p for p in multiple_plugins if p.plugin_type == PluginType.HOOK)
        hook_plugin.disable()
    ...
    def test_activate_all_disabled_plugins_skipped(self, registry) -> None:
        ...
        enabled_plugin = TestPlugin(PluginMetadata("enabled", "1.0.0", PluginType.HOOK, "Test"))
        disabled_plugin = TestPlugin(PluginMetadata("disabled", "1.0.0", PluginType.HOOK, "Test"))

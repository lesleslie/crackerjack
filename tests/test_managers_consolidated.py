...
class TestTestManagementImpl:
    ...
    def test_run_tests_success(self, temp_project) -> None:
        manager = create_test_manager_with_path(temp_project)
    ...
    def test_test_disabled(self, temp_project) -> None:
        manager = create_test_manager_with_path(temp_project)
    ...
    def test_benchmark_mode(self, temp_project) -> None:
        manager = create_test_manager_with_path(temp_project)
    ...
    def test_test_workers_configuration(self, temp_project) -> None:
        manager = create_test_manager_with_path(temp_project)
    ...
    def test_test_timeout_configuration(self, temp_project) -> None:
        manager = create_test_manager_with_path(temp_project)
    ...
    def test_parse_test_statistics_success(self, temp_project) -> None:
    ...
    def test_parse_test_statistics_with_failures(self, temp_project) -> None:
    ...
    def test_parse_test_statistics_with_errors(self, temp_project) -> None:
    ...
    def test_parse_test_statistics_with_xfail_xpass(self, temp_project) -> None:
    ...
    def test_parse_test_statistics_with_coverage(self, temp_project) -> None:
    ...
    def test_parse_test_statistics_empty_output(self, temp_project) -> None:
...
class TestManagersIntegration:
    def test_managers_work_together(self, console, temp_project) -> None:
        test_manager = create_test_manager_with_path(temp_project, console=console)

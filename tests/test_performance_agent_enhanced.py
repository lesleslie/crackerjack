...
class TestNestedLoopDetection:
    ...
    @pytest.mark.asyncio 
    async def test_detect_simple_nested_loops(self, performance_agent, temp_python_file) -> None:
...
""")
        ...
        assert any(keyword in recommendations_text for keyword in ["nested", "o(n", "complexity", "loop"])

    @pytest.mark.asyncio
    async def test_complexity_priority_classification(self, performance_agent, temp_python_file) -> None:
...
""")
        ...
        assert result.recommendations is not None
        recommendations_text = " ".join(result.recommendations).lower()
        assert any(keyword in recommendations_text for keyword in ["critical", "o(n", "high", "complexity"])
...
class TestListOperationOptimization:
    ...
    @pytest.mark.asyncio
    async def test_list_concatenation_in_loops(self, performance_agent, temp_python_file) -> None:
...
""")
    ...
    @pytest.mark.asyncio
    async def test_performance_impact_assessment(self, performance_agent, temp_python_file) -> None:
...
class TestStringOptimization:
    ...
    @pytest.mark.asyncio
    async def test_string_concatenation_patterns(self, performance_agent, temp_python_file) -> None:
...
""")
    ...
    @pytest.mark.asyncio
    async def test_string_impact_assessment(self, performance_agent, temp_python_file) -> None:
...
""")
        ...
        assert result.success is True
        assert any("high-impact" in rec.lower() or "impact factor" in rec.lower() 
...
class TestBuiltinOptimization:
    ...
    @pytest.mark.asyncio
    async def test_repeated_builtin_calls(self, performance_agent, temp_python_file) -> None:
...
""")
        ...
        assert any("Cache sorted(" in line or "Cache max(" in line 
...
class TestComprehensiveOptimization:
    ...
    @pytest.mark.asyncio
    async def test_multiple_optimization_types(self, performance_agent, temp_python_file) -> None:
...
""")
        ...
        performance_comments = [line for line in optimized_content.split('\n') 
...
class TestPerformanceMetrics:
    ...
    @pytest.mark.asyncio
    async def test_performance_measurement_tracking(self, performance_agent, temp_python_file) -> None:
...
class TestRealWorldScenarios:
    ...
    @pytest.mark.asyncio
    async def test_data_processing_scenario(self, performance_agent, temp_python_file) -> None:
...
""")
        ...
        assert "results.append(" in optimized_content or "results.extend(" in optimized_content

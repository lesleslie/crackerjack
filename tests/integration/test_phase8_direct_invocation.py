...
class TestFastHooksIntegration:
    ...
    def test_fast_hooks_count(self) -> None:
        ...
        17 since 9cc2f9c6 (2026-09) promoted ``audit-type-checking-runtime-refs``
        from comprehensive-weekly to fast. Previous baseline was 16 after
        2af1c560 (2026-08-11) removed skill-coverage from FAST_HOOKS. The
        count was briefly 17 while that hook was wired in (a8dad1c9). If this
        assertion fails, confirm whether a hook was added or removed on

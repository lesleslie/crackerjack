...
class TestInteractiveCLI:
    ...
    def test_get_user_preferences_with_advanced_options(self, cli):
        ...
        confirm_responses = [False, False, False, True, True]  # clean, test, commit, advanced, verbose
...
class TestInteractiveCLIIntegration:
    ...
    def test_cli_components_work_together(self):
        ...
        with patch('crackerjack.cli.interactive.Console'), \
    ...
    def test_task_dependency_structure(self):
        ...
        task3 = InteractiveTask("task3", "Third task", "method3", dependencies=[task1, task2])

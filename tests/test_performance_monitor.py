...
@pytest.mark.skip(reason="Function record_operation_start does not exist in performance_monitor module")
...
@pytest.mark.skip(reason="Function get_operation_metrics does not exist in performance_monitor module")
...
@pytest.mark.skip(reason="Function print_performance_report does not exist in performance_monitor module")

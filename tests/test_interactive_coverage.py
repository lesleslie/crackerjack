...
from crackerjack.interactive import (
    TaskStatus, WorkflowOptions, TaskDefinition, Task, WorkflowBuilder,
    ModernWorkflowManager, ModernInteractiveCLI, TaskExecutor
)
...
class TestModernWorkflowManager:
    """Test ModernWorkflowManager class."""
    ...
    def workflow_manager(self, console):
        """Create ModernWorkflowManager instance."""
        return ModernWorkflowManager(console)
    ...
    def sample_workflow(self):
        ...
        return {
            ...
            "task2": TaskDefinition("task2", "Task 2", "Second task", dependencies=["task1"]),
            "task3": TaskDefinition("task3", "Task 3", "Third task", dependencies=["task1"])
        }
    
    def test_initialization(self, workflow_manager, console):
        """Test ModernWorkflowManager initialization."""
    ...
    def test_set_task_executor_nonexistent_task(self, workflow_manager, sample_workflow):
    ...
    def test_get_next_task_with_completed_dependency(self, workflow_manager, sample_workflow):
...
class TestModernInteractiveCLI:
    """Test ModernInteractiveCLI class."""
    ...
    def cli(self, console):
        """Create ModernInteractiveCLI instance."""
    ...
    def test_workflow_phase_methods(self, cli):
        ...
        builder.add_conditional_task.return_value = ""  # Mock returns empty string for disabled
    ...
    def test_execute_workflow_loop_with_failure(self, cli):
        ...
        with patch.object(cli, '_should_run_task', return_value=True):
            with patch.object(cli, '_execute_single_task', return_value=False):
                with patch.object(cli, '_should_continue_after_failure', return_value=False):
                    with patch.object(cli, '_display_workflow_summary'):
                        result = cli._execute_workflow_loop()
...
class TestLegacyInteractiveCLI:
    ...
    def test_create_standard_workflow(self, cli):
        ...
        expected_tasks = ["setup", "config", "clean", "hooks", "test", "version", "publish", "commit"]

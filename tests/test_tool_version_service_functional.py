...
class TestToolVersionServiceFunctional:
    ...
    def test_real_integration_if_tools_available(self, service: ToolVersionService) -> None:
...
class TestToolVersionServiceComprehensive:
    ...
    def test_concurrent_tool_checking(self, service: ToolVersionService) -> None:
        ...
        with patch('subprocess.run') as mock_run:
            ...
            assert all(r1.tool_name == r2.tool_name for r1, r2 in zip(results1, results2))
    ...
    def test_memory_usage_with_repeated_calls(self, service: ToolVersionService) -> None:

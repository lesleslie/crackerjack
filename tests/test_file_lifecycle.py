def test_atomic_file_write_basic(self):
...
def test_locked_file_access_basic(self):
...
def test_safe_directory_creation_basic(self):
...
def test_writelines_basic(self):
...
def test_file_handle_basic(self):
...
def test_add_write_operation_basic(self):
...
def test_add_copy_operation_basic(self):
...
def test_add_move_operation_basic(self):
...
def test_add_delete_operation_basic(self):
...
def test_commit_all_basic(self):
...
def test_safe_read_text_basic(self):
...
def test_safe_copy_file_basic(self):

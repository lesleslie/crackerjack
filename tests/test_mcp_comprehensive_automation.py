...
class TestContextualAIAssistantComprehensive:
    ...
    def test_initialization(self, ai_assistant, mock_filesystem_protocol):
    ...
    @pytest.mark.asyncio
    async def test_detect_project_issues(self, ai_assistant, mock_filesystem_protocol):
    ...
    @pytest.mark.asyncio
    async def test_cache_context(self, ai_assistant, mock_filesystem_protocol):
    ...
    @pytest.mark.asyncio
    async def test_load_cached_context(self, ai_assistant, mock_filesystem_protocol):
    ...
    def test_priority_scoring(self, ai_assistant):
...
class TestMCPServerComprehensive:
    ...
    @pytest.mark.asyncio
    async def test_mcp_server_startup(self, mock_mcp_server):
    ...
    @pytest.mark.asyncio
    async def test_mcp_server_shutdown(self, mock_mcp_server):
        """Test MCP server graceful shutdown"""
        await mock_mcp_server.stop()

        mock_mcp_server.stop.assert_called_once()

    def test_job_creation(self, mock_job_manager):
    ...
    def test_job_progress_tracking(self, mock_job_manager):
    ...
    def test_job_completion(self, mock_job_manager):
...
class TestWebSocketIntegrationComprehensive:
    ...
    @pytest.mark.asyncio
    async def test_websocket_server_startup(self, mock_websocket_server):
    ...
    @pytest.mark.asyncio
    async def test_websocket_progress_broadcasting(self, mock_websocket_server):
    ...
    @pytest.mark.asyncio
    async def test_websocket_message_handling(self, mock_websocket_handler):
    ...
    @pytest.mark.asyncio
    async def test_websocket_progress_updates(self, mock_websocket_handler):
    ...
    @pytest.mark.asyncio
    async def test_websocket_connection_error_handling(self, mock_websocket_connection):
    ...
    def test_websocket_job_management(self):
...
class TestMCPToolsComprehensive:
    ...
    @pytest.mark.asyncio
    async def test_execute_crackerjack_tool(self, mock_execution_context):
    ...
    @pytest.mark.asyncio
    async def test_get_comprehensive_status_tool(self):
    ...
    @pytest.mark.asyncio
    async def test_get_job_progress_tool(self, mock_execution_context):
...
class TestMCPAIIntegration:
    ...
    @pytest.mark.asyncio
    async def test_websocket_ai_integration(self, mock_websocket_server):
...
class TestMCPAIErrorHandling:
    ...
    @pytest.mark.asyncio
    async def test_websocket_connection_failures(self, mock_websocket_connection):
    ...
    @pytest.mark.asyncio
    async def test_mcp_tool_execution_errors(self):

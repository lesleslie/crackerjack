...
class TestPublishManagerImpl:
    ...
    def test_init(self, publish_manager, console, pkg_path):
    ...
    def test_bump_version_patch(self, publish_manager):
    ...
    def test_bump_version_minor(self, publish_manager):
    ...
    def test_bump_version_major(self, publish_manager):
    ...
    def test_publish_package_success(self, publish_manager):
    ...
    def test_publish_package_failure(self, publish_manager):
    ...
    def test_validate_auth(self, publish_manager):
    ...
    def test_build_package_success(self, publish_manager):
    ...
    def test_build_package_dry_run(self, publish_manager):
    ...
    def test_create_git_tag(self, publish_manager):
    ...
    def test_get_current_version(self, publish_manager):
    ...
    def test_calculate_next_version(self, publish_manager):
    ...
    def test_get_package_info(self, publish_manager):
    ...
    def test_cleanup_old_releases(self, publish_manager):
...
class TestPublishManagerCoverage:
    ...
    def test_util_methods_exist(self):

"""Tests for advanced Python 3.13+ features."""
...
class TestPy313Advanced:
    ...
    def test_process_command_output_unknown_case(self) -> None:
        ...
        success, message = process_command_output(weird_result)  # type: ignore
        assert not success
    ...
    def test_analyze_hook_result_unknown_case(self) -> None:
        ...
        weird_result: HookResult = {
            "status": CustomStatus.CUSTOM,  # type: ignore
            "hook_id": "custom",
            "output": "",
            "files": [],
        }

...
class TestPluginBase:
    ...
    def test_plugin_registry_get_not_found(self):
    ...
    def test_plugin_registry_has_plugin(self):
    ...
    def test_plugin_registry_get_plugin_count(self):
...
class TestPluginLoader:
    ...
    def test_load_plugin_from_path_not_exists(self, plugin_loader):
        """Test loading plugin from non-existent path."""
        result = plugin_loader.load_plugin_from_path(Path("/non/existent/plugin.py"))

        assert result is None

    def test_validate_plugin_structure_invalid(self, plugin_loader):
    ...
    def test_validate_plugin_structure_valid(self, plugin_loader):
    ...
    def test_get_loaded_plugins(self, plugin_loader):
        """Test getting list of loaded plugins."""
        plugins = plugin_loader.get_loaded_plugins()

        assert isinstance(plugins, list)

    def test_unload_plugin(self, plugin_loader):
    ...
    def test_unload_plugin_not_found(self, plugin_loader):
        """Test unloading non-existent plugin."""
        result = plugin_loader.unload_plugin("non_existent")

        assert result is False

    def test_reload_plugin(self, plugin_loader):
    ...
    def test_get_plugin_info_not_found(self, plugin_loader):
        """Test getting info for non-existent plugin."""
        info = plugin_loader.get_plugin_info("non_existent")

        assert info is None

    def test_list_plugin_files(self, plugin_loader, temp_plugin_dir):
...
class TestHookPluginBase:
    ...
    def test_hook_plugin_base_import(self):
        """Test HookPluginBase can be imported."""
        assert HookPluginBase is not None

    def test_hook_plugin_base_abstract_methods(self):
    ...
    def test_hook_plugin_base_cannot_instantiate(self):
...
class TestPluginManager:
    ...
    def test_initialize_plugins(self, plugin_manager):
    ...
    def test_load_plugin_by_name(self, plugin_manager):
    ...
    def test_unload_plugin_by_name(self, plugin_manager):
    ...
    def test_get_active_plugins(self, plugin_manager):
    ...
    def test_cleanup_plugins(self, plugin_manager):
    ...
    def test_get_plugin_configuration(self, plugin_manager):
        """Test getting plugin configuration."""
        config = plugin_manager.get_plugin_configuration("test_plugin")

        assert isinstance(config, dict)

    def test_set_plugin_configuration(self, plugin_manager):

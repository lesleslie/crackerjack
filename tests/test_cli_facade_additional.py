...
class TestCLIFacadeAdditional:
    ...
    def test_process_with_successful_workflow(self, facade):
    ...
    def test_process_with_failed_workflow(self, facade):
    ...
    def test_process_with_exception_non_verbose(self, facade):
    ...
    def test_process_with_exception_verbose(self, facade):
    ...
    def test_process_with_keyboard_interrupt(self, facade):
    ...
    def test_should_handle_special_mode_false_cases(self, facade):
    ...
    def test_should_handle_special_mode_true_cases(self, facade):
    ...
    def test_start_mcp_server_success_path(self, facade):
    ...
    def test_start_mcp_server_import_error_handling(self, facade):
    ...
    def test_start_mcp_server_general_exception(self, facade):
    ...
    def test_process_special_mode_integration(self, facade):
    ...
    def test_facade_attributes(self, facade):
    ...
    def test_facade_console_and_path_types(self, facade):
        """Test facade attribute types."""
        assert facade.console is not None
        assert isinstance(facade.pkg_path, Path)

    def test_missing_attributes_in_options(self, facade):
    ...
    def test_handle_special_modes_with_missing_attributes(self, facade):
...
class TestCreateCrackerjackRunner:
    ...
    def test_create_runner_with_params(self):
    ...
    def test_create_runner_with_defaults(self):
...
class TestCrackerjackRunnerAlias:
    ...
    def test_runner_alias_is_facade(self):
        """Test that CrackerjackRunner is the same as CrackerjackCLIFacade."""
        from crackerjack.cli.facade import CrackerjackRunner, CrackerjackCLIFacade
        
        assert CrackerjackRunner is CrackerjackCLIFacade

    def test_runner_alias_functionality(self):
...
class TestProcessAsyncMethod:
    ...
    @pytest.mark.asyncio
    async def test_process_async_delegates_to_sync(self):

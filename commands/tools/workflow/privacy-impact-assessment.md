...
Introduce dedicated guidance for evaluating privacy risk, data flows, and regulatory obligations before launch.

## Requirements

- Classify data types, processing purposes, and jurisdictions.
- Document controls, mitigations, and approval records.
- Coordinate with engineering and product decisions affecting data handling.

## Inputs

- `$INITIATIVE` — project or feature under review.
- `$DATA_CATEGORIES` — list of personal or sensitive data involved.
- `$JURISDICTIONS` — markets or regulations (GDPR, CCPA, etc.).

## Outputs

- Completed privacy impact assessment (PIA) report.
- Mitigation backlog with owners and due dates.
- Approval log for audit readiness.

## Instructions

1. **Scope the assessment**

   - Gather context from Product, Architecture, and Data teams.
   - Identify data sources, processors, and data subjects.

1. **Evaluate risks**

   - Assess lawful bases, consent mechanisms, and data minimization practices.
   - Rate risks by impact and likelihood; propose mitigations.

1. **Plan controls**

   - Recommend technical (encryption, access controls) and procedural safeguards.
   - Align with retention schedules and incident response plans.

1. **Document approvals**

   - Compile findings into the PIA template, secure sign-off from Privacy Officer and Legal, and store in the compliance repository.

## Dependencies

- Collaboration with Privacy Officer, Data Retention Specialist, and Architecture Council.
- Access to data inventories and processing records.
- Legal guidance for jurisdiction-specific obligations.

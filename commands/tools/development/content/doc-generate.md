...
class APIDocExtractor:
    ...
    def _extract_parameters(self, func_node):
        ...
        for arg in func_node.args.args:
            param = {"name": arg.arg, "type": None, "required": True, "description": ""}
...
# Create user
new_user = client.users.create(email="user@example.com", name="John Doe")
```
    ...
    def check_coverage(self, codebase_path):
        ...
        for file_path in glob.glob(f"{codebase_path}/**/*.py", recursive=True):
            ...
            if ast.get_docstring(module):
                ...
                results["missing_docs"].append({"type": "module", "file": file_path})

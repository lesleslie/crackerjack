...
class BatchFileOperations:
    ...
    async def _write_single_async(
        ...
        try:
            ...
            async with aiofiles.path.open("w", encoding="utf-8") as f:  # ty: ignore[unresolved-attribute]
...
class EnhancedFileSystemService(EnhancedFileSystemServiceProtocol, ServiceProtocol):
    ...
    def read_file(self, path: str | Path) -> str:
        ...
        with LoggingContext("read_file", path=path_obj):
    ...
    def write_file(self, path: str | Path, content: str) -> None:
        ...
        with LoggingContext("write_file", path=path_obj, size=len(content)):

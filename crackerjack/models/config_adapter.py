...
class OptionsAdapter:
    ...
    def from_options_protocol(options: OptionsProtocol) -> WorkflowOptions:
        ...
        return WorkflowOptions(
            ...
            testing=TestConfig(
                ...
                benchmark_regression_threshold=getattr(options, 'benchmark_regression_threshold', 0.1),
    ...
    @staticmethod
    def to_options_protocol(workflow_options: WorkflowOptions) -> 'LegacyOptionsWrapper':

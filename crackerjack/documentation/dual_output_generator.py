...
class DualOutputGenerator:
    ...
    def __init__(
        ...
        # Documentation paths
        self.ai_reference_path = self.project_path / "AI-REFERENCE.md"
        self.agent_capabilities_path = self.project_path / "AGENT-CAPABILITIES.json"
        self.error_patterns_path = self.project_path / "ERROR-PATTERNS.yaml"
...
"""
    ...
    async def _generate_agent_capabilities(self) -> dict[str, Any]:
    ...
    async def _generate_error_patterns(self) -> dict[str, Any]:
...
| `complexity > 15` | RefactoringAgent | ✅ | Break into helper methods |"""
    ...
    def _extract_agent_specializations(self, agent) -> list[str]:
    ...
    def _extract_input_patterns(self, agent) -> list[str]:
    ...
    def _build_type_error_patterns(self) -> dict[str, Any]:
                ...
                "examples": [
                    {
                        ...
                        "after": "def process(data: dict[str, Any]):",
                    }
                ],
            },
        }

    def _build_security_patterns(self) -> dict[str, Any]:
    ...
    def _build_performance_patterns(self) -> dict[str, Any]:
    ...
    def _build_testing_patterns(self) -> dict[str, Any]:
    ...
    def _build_formatting_patterns(self) -> dict[str, Any]:
    ...
    def _build_import_patterns(self) -> dict[str, Any]:
    ...
    def _build_complexity_patterns(self) -> dict[str, Any]:
    ...
    def _needs_regeneration(self) -> bool:
        ...
        source_paths = list(Path("crackerjack").rglob("*.py"))
        if not source_paths:
            return True

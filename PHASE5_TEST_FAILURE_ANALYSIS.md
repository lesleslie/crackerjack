...
2. `tests/orchestration/test_cache_adapters.py`
3. `tests/orchestration/test_config.py`
4. `tests/orchestration/test_hook_orchestrator.py`
5. `tests/managers/test_hook_manager_orchestration.py`
6. `tests/managers/test_hook_manager_triple_parallel.py`
7. `tests/performance/test_triple_parallelism_benchmarks.py`
8. `tests/unit/orchestration/test_advanced_orchestrator.py`
9. `tests/unit/orchestration/test_execution_strategies.py`
10. `tests/unit/orchestration/test_hook_orchestrator.py`
11. `tests/unit/orchestration/test_hook_result_details.py`
12. `tests/unit/orchestration/test_issue_count_fix.py`
...
2. `tests/orchestration/test_hook_orchestrator_events.py`
3. `tests/test_workflow_event_bus.py`
...
2. `tests/services/test_health_metrics_repository.py`
3. `tests/test_services_coverage.py` (partial - has inline import)
...
2. `tests/test_acb_settings_integration.py`
3. `tests/test_core_comprehensive.py`
4. `tests/test_stage_workflow_execution_order.py`
5. `tests/test_workflow_orchestrator.py`
6. `tests/test_workflow_orchestrator_ai_routing.py`
...
2. `tests/test_main_module.py` (1 import check)
...
2. `tests/test_main_module.py` - Remove `handle_dashboard_mode` import check (1 line)
3. `tests/test_services_coverage.py` - Remove inline monitoring import (1 class)
...
2. ✅ Obsolete tests removed (~100 tests)
3. ✅ Remaining tests run without import errors (3,734 tests collected)
4. ⏳ Actual test failures categorized and fixed
...
2. ✅ `crackerjack/services/enhanced_filesystem.py` - Moved `from __future__ import annotations` to first line
3. ✅ `crackerjack/runtime/__init__.py` - Added missing `write_pid_file` export
4. ✅ `crackerjack/mcp/server_core.py` - Replaced `acb_console.console` → `Console()`
...
2. ✅ `tests/test_main_module.py` - Removed dashboard/enhanced monitor handler imports
3. ✅ `tests/test_services_coverage.py` - Removed monitoring infrastructure test classes
...
2. ⏳ Categorize and fix remaining test failures

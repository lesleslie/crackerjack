...
2. **Output Formatting** (1 test) - Fix indentation expectation
3. **Simple tool tests** (5-10 tests) - Update expectations to match implementations
...
5. **Security Service** (5 tests) - Fix hardcoded secret detection
6. **Code Cleaner** (1 test) - Fix pattern registry OR update test expectations

### Phase 3: Bulk Fixes (4-8 hours)
**Goal**: Clear remaining failures

7. **Adapter tests** (Skylos, etc.) - Batch fix similar patterns
8. **Tool tests** (Large files, YAML, whitespace) - Update expectations
9. **Integration tests** - Fix one-by-one based on root cause
...
2. **Fix Output Formatting test** (5 minutes) - Simple indentation fix
3. **Investigate SessionCoordinator** (15 minutes) - Determine if test or impl fix
4. **Batch fix similar adapter tests** (30 minutes) - Skylos and others

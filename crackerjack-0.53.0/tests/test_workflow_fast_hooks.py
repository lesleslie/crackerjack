...
def test_direct_crackerjack_behavior() -> bool:
    ...
    if result.returncode == 0:  # Fast hooks passed
        return bool(has_tests or result2.returncode == 0)
...
def test_workflow_with_external_project() -> bool | None:
    ...
    try:
        ...
        return bool(has_hooks)

    finally:
        os.chdir(original_dir)


def test_workflow_with_bad_formatting() -> bool | None:
...
def check_phase_coordinator_implementation() -> bool | None:

...
class TestEndOfFileDetection:
    ...
    def test_detects_missing_newline(self) -> None:
    ...
    def test_detects_correct_newline(self) -> None:
    ...
    def test_detects_multiple_newlines(self) -> None:
...
class TestEndOfFileFixer:
    ...
    def test_fixes_missing_newline(self, tmp_path) -> None:
    ...
    def test_fixes_multiple_newlines(self, tmp_path) -> None:
    ...
    def test_no_modification_when_correct(self, tmp_path) -> None:
    ...
    def test_preserves_unix_newlines(self, tmp_path) -> None:
    ...
    def test_handles_windows_newlines(self, tmp_path) -> None:
    ...
    def test_handles_binary_files(self, tmp_path) -> None:
    ...
    def test_multiline_content(self, tmp_path) -> None:
...
class TestEndOfFileCLI:
    ...
    def test_cli_check_mode_correct_file(self, tmp_path) -> None:
    ...
    def test_cli_mixed_correct_and_incorrect(self, tmp_path) -> None:
...
class TestEndOfFileEdgeCases:
    ...
    def test_file_with_only_whitespace(self, tmp_path) -> None:
    ...
    def test_very_long_file(self, tmp_path) -> None:
    ...
    def test_many_trailing_newlines(self, tmp_path) -> None:
    ...
    def test_mixed_newline_types(self, tmp_path) -> None:
...
class TestEndOfFileIntegration:
    ...
    def test_preserves_file_permissions(self, tmp_path) -> None:

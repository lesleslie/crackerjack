...
Fill the tooling gap for customer support enablement, health monitoring, and communication plans during launches or escalations.

## Requirements

- Define success plans, escalation matrices, and enablement assets.
- Provide dashboards for ticket trends, satisfaction, and churn risks.
- Coordinate with Product, Delivery, and Compliance on messaging.

## Inputs

- `$CUSTOMER_SEGMENT` — target users or accounts.
- `$RELEASE_OR_INCIDENT` — context driving the support plan.
- `$METRICS` — KPIs such as CSAT, response time, or churn probability.

## Outputs

- Support readiness checklist and training plan.
- Executive business review template.
- Escalation matrix with owners and SLAs.

## Instructions

1. **Assess current signals**

   - Pull ticket, chat, and telemetry data; highlight trending issues.
   - Review prior commitments and outstanding action items.

1. **Prepare enablement**

   - Draft help center updates, success plan templates, and communication cadences.
   - Align with Product/Delivery on known risks and feature toggles.

1. **Define escalation workflow**

   - Map severity tiers, response targets, and communication channels.
   - Pre-stage customer notifications for incidents or major releases.

1. **Measure and iterate**

   - Track adoption of support assets and update dashboards weekly.
   - Feed insights into backlog prioritization and quality improvements.

## Dependencies

- Access to support platforms and analytics tooling.
- Collaboration with Product Manager, Delivery Lead, and Privacy Officer.
- Clear data governance for handling customer information.

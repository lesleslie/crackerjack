...
skylos_refactor = UUID("445401b8-b273-47f1-9015-22e721757d46")  # Note: skylos appears in both LSP and refactor
```
...
zuban_type = UUID("e42fd557-ed29-4104-8edd-46607ab807e2")  # Note: zuban appears in LSP and type
```

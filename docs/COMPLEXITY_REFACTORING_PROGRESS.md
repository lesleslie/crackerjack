...
2. ✅ crackerjack/mcp/tools/skill_tools.py
3. ✅ crackerjack/agents/semantic_agent.py
4. ✅ crackerjack/agents/helpers/performance/performance_recommender.py
5. ✅ crackerjack/models/config.py
6. ✅ crackerjack/services/config_service.py
7. ✅ crackerjack/data/repository.py
...
2. **Refactor script functions** (2 functions, complexity 16-22)

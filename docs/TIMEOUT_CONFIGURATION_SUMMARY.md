...
2. **Alert if tools approach 80% of timeout threshold**
3. **Consider batching** for very large codebases (>100k LOC)

### Configuration Best Practices
1. **Keep pyproject.toml as source of truth** for default values
2. **Adapter code should reference these values** (future enhancement)
3. **Document changes** in this file when timeouts are adjusted

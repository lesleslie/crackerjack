...
2. `/Users/les/Projects/crackerjack/crackerjack/services/ai/embeddings.py`
3. `/Users/les/Projects/crackerjack/crackerjack/services/quality/quality_intelligence.py`
4. `/Users/les/Projects/crackerjack/crackerjack/cli/handlers.py`
5. `/Users/les/Projects/crackerjack/crackerjack/cli/handlers/main_handlers.py`
6. `/Users/les/Projects/crackerjack/crackerjack/managers/publish_manager.py`
7. `/Users/les/Projects/crackerjack/crackerjack/cli/handlers/coverage.py`
8. `/Users/les/Projects/crackerjack/crackerjack/mcp/tools/core_tools.py`
9. `/Users/les/Projects/crackerjack/crackerjack/mcp/tools/execution_tools.py`
...
2. **Import Cleanup**: Add missing imports for `WorkflowPipeline`, `ConfigTemplateService`, etc.
3. **Protocol Alignment**: Ensure all concrete implementations match their protocols exactly
4. **Logger Typing**: Use proper logger protocol instead of `object` type
5. **Async Type Fixing**: Resolve `Coroutine` vs `Task` vs `Awaitable` confusion

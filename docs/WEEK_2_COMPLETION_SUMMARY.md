...
2. Subtract 0.10 for docstrings
3. Subtract 0.15 for recent git modifications
4. Set to 0.0 for protected decorators
5. Set to 0.95 for imports (always safe)
6. Require ≥0.80 for auto-removal

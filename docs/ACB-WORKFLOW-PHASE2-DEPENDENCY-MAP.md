...
2. ✅ RegexPatterns (static - might need wrapper)
3. ✅ GitService as GitServiceProtocol (reuse Level 3 instance)
4. ✅ ChangelogGenerator (@depends.inject)
5. ⚠️ VersionAnalyzer (need to find class)

### Week 1 Day 4: Level 4 (Managers Part 1)
1. ✅ HookManager (simple - pkg_path + options)
2. ⏳ Start Level 4.5 (TestManager dependencies)

### Week 1 Day 5: Level 4.5 + Level 4 Part 2
1. ✅ CoverageRatchet
2. ✅ CoverageBadgeService
3. ✅ LSPClient
4. ✅ TestManager (now dependencies available)
5. ✅ PublishManager (all Level 3.5 dependencies registered)

### Week 2 Day 1-2: Level 5 (Executors)
1. ParallelHookExecutor
2. AsyncCommandExecutor

### Week 2 Day 3: Level 6 (Coordinators)
1. SessionCoordinator (simple)
2. PhaseCoordinator (complex - needs all Levels 1-5)
...
2. **ConfigMergeServiceProtocol**: Referenced by PhaseCoordinator
   - Find implementation file
   - Understand dependencies

3. **QualityIntelligenceProtocol**: Optional for WorkflowPipeline
   - Find implementation
   - Decide if needed for Phase 2

4. **PerformanceBenchmarkProtocol**: Optional for WorkflowPipeline
   - Find implementation
   - Decide if needed for Phase 2

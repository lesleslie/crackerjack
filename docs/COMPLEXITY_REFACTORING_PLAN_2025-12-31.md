...
2. **mcp/tools/skill_tools.py** - 3 functions (53 total complexity)
3. **agents/semantic_agent.py** - 1 function (20 complexity)
4. **agents/helpers/performance/performance_recommender.py** - 2 functions (35 complexity)
...
6. **services/config_service.py** - 1 function (18 complexity)
7. **data/repository.py** - 1 function (16 complexity)
8. **tools/validate_regex_patterns_standalone.py** - 1 function (22 complexity)
...
10. **tests/test_syntax_validation.py** - 1 function (20 complexity)
11. **tests/test_terminal_state.py** - 1 function (19 complexity)
12. **tests/test_ai_agent_workflow.py** - 1 function (16 complexity)
13. **tests/test_terminal_restoration.py** - 1 function (16 complexity)
14. **scripts/audit_command_consistency.py** - 1 function (16 complexity)
...
2. Run `python -m pytest tests/<specific_test>.py -v` for relevant tests
3. Check for any import or type errors

After all refactoring:
1. Run full complexipy scan: `uv run complexipy . --failed` (should find 0 issues)
2. Run full test suite: `python -m crackerjack run --run-tests`
3. Run quality checks: `python -m crackerjack run`
